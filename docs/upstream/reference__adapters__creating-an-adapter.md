...
\`\`\`ts
export const type = "my\_adapter";
export const label = "My Adapter";
export const models = \[{ id: "model-a", label: "Model A" }\];
export const agentConfigurationDoc = \`# my\_adapter agent configuration
...
\| \`buildPaperclipEnv()\` \| Inject the standard \`PAPERCLIP\_\*\` variables. \|
