...
1\. Paperclip builds the runtime environment and injects the standard \`PAPERCLIP\_\*\` variables.
...
\- If your script needs to call back into Paperclip, use the injected \`PAPERCLIP\_API\_URL\` and \`PAPERCLIP\_API\_KEY\`.
